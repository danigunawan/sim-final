...
<div class="container">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <ul class="breadcrumb">
              <li>Home</li>
              <li><router-link :to="{name: 'IndexRegistrasiRawatJalan'}"> Registrasi Rawat Jalan</router-link></li>
              <li class="active">Tambah Registrasi Rawat Jalan</li>
            </ul>

            <div class="panel panel-default">
                <div class="panel-heading">Tambah Registrasi Rawat Jalan</div>
...
<script>
  export default {
    ...
    methods: {
     ...
     var url = app.url.replace('registrasi-rawat-jalan','pasien/pencarian-registrasi?');
     ...
     var app = this;
      ...
      alert(pesan){
        this.$swal({
          title: "Berhasil Menambah Registrasi Rawat Jalan",
          text: pesan,
          icon: "success"
        });
      },
      saveForm(){
        ...
        .then((resp) => {
          this.alert('Berhasil Menambah Registrasi Rawat Jalan ' + this.registrasi.nama );
