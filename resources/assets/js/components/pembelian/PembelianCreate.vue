    ...
    <div class="row">
        <div class="col-md-12 ">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">Tambah Pembelian</div>
...
<script>
  export default {
    ...
    mounted()  {
     ...
     app.getKas();
     app.getSupplier();
     app.getDetailPembelian();
    },    
    methods: {
      deleteDetailPembelian(id){
          axios.delete(this.url + '/' + id + '/delete-tbs-pembelian')
          .then((resp) => {
     ...
     var app = this;
     app.loading = true;
        axios.get(app.url + '/create-detail-pembelian')
        .then(function(resp){
     ...
     var app = this;
      ...
      saveForm(){
        ...
        axios.post(this.url,newPembelian)
        .then((resp) => {
          this.alert('Berhasil Menambah Pembelian','Pembelian Berhasil Dilakukan Senilai: '
                     +this.pembelian.total_nilai,'success');
     ...
     saveFormInputDetailPembelian(){
        ...
        axios.post(this.url + '/store-tbs-pembelian',newDetailPembelian)
        .then((resp) => {
