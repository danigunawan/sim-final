    ...
    <div class="row">
        <div class="col-md-12 ">
            <ul class="breadcrumb">
              ...
              <li class="active">Tambah Penjualan Apotek</li>
            </ul>
            <div class="panel panel-default">
                <div class="panel-heading">Tambah Penjualan Apotek</div>
...
<script>
  export default {
    ...
    watch: {
      'penjualanApotek.penjamin': {
        handler(val){
          this.inputPenjualanApotek.penjamin = val;    
        }  
      },
    ...
    mounted()  {
     ...
     app.getKas();
     app.getPenjamin();
     app.getDetailPenjualanApotek();
    },    
    methods: {
      deleteDetailPenjualanApotek(id){
          axios.delete(this.url + '/' + id + '/delete-tbs-penjualan-apotek')
          .then((resp) => {
     ...
     var app = this;
     app.loading = true;
        axios.get(app.url + '/create-detail-penjualan-apotek')
        .then(function(resp){
     ...
     var app = this;
      ...
      saveForm(){
        ...
        axios.post(this.url,newPenjualanApotek)
        .then((resp) => {
          this.alert('Berhasil Menambah Penjualan Apotek','Penjualan Apotek Berhasil Dilakukan Senilai: '
                     +this.penjualanApotek.total_nilai,'success');
     ...
     saveFormInputDetailPenjualanApotek(){
        ...
        axios.post(this.url + '/store-tbs-penjualan-apotek',newDetailPenjualanApotek)
        .then((resp) => {
