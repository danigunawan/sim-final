    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <ul class="breadcrumb">
              ...
              <li class="active">Kelola Penjualan Apotek</li>
            </ul>
            <div class="panel panel-default">
                <div class="panel-heading">Kelola Penjualan Apotek</div>

                <div class="panel-body">

                    <router-link 
                      :to="{name: 'CreatePenjualanApotek'}" 
                      class="btn btn-md btn-primary"> 
                        Tambah Penjualan Apotek
                    </router-link>
                    <br/>
  ...
  export default {
    ...
    methods: {
      ...
      deleteEntry(id,index,noTrans){
          ...
          .then((resp) => {
            this.getResults();
            this.alert("Berhasil Menghapus","Berhasil Menghapus Penjualan Apotek " + noTrans);
          })
          .catch((resp) =>{
      ...
      konfirmasiHapus(id,index,noTrans){
        ...
        this.$swal({
          title: "Yakin Ingin Menghapus Penjualan Apotek : " + noTrans + "?",
