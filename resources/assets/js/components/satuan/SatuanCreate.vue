    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">Tambah Satuan</div>
...
<script>
  export default {
    ...
    methods: {
      alert(pesan){
        this.$swal({
          title: "Berhasil Menambah Satuan",
          text: pesan,
          icon: "success"
        });
      },
      saveForm(){
        ...
        axios.post(this.url,newSatuan)
        .then((resp) => {
          this.alert('Berhasil Menambah Satuan ' + this.satuan.nama );
