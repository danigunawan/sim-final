    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">Edit  Item Masuk</div>
...
<script>
  export default {
    ...
    methods: {
      getEditingData(){
         var app = this;
         this.itemMasukId = this.$route.params.id;
         axios.get(app.url+'/'+this.itemMasukId+ '/edit')
         .then((resp) => {
           this.itemMasuk =  resp.data;
         })
         .catch((resp) => {
     ...
     var app = this;
      ...
      alert(pesan){
        this.$swal({
          title: "Berhasil Mengubah Item Masuk",
          text: pesan,
          icon: "success"
        });
      },
      saveForm(){
        ...
        axios.patch(this.url + '/' + this.itemMasukId, newItemMasuk)
        .then((resp) => {
          this.alert('Berhasil Mengubah ItemMasuk ' + this.itemMasuk.nama );
