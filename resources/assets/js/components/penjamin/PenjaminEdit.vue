    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">Edit  Penjamin</div>
...
<script>
  export default {
    ...
    methods: {
      alert(pesan){
        this.$swal({
          title: "Berhasil Mengubah Penjamin",
          text: pesan,
          icon: "success"
        });
      },
      saveForm(){
        ...
        axios.patch(this.url + '/' + this.supplierId, newPenjamin)
        .then((resp) => {
          this.alert('Berhasil Mengubah Penjamin ' + this.penjamin.nama );
