    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <ul class="breadcrumb">
              ...
              <li class="active">Tambah Komisi Produk Per User</li>
            </ul>
            <div class="panel panel-default">
                <div class="panel-heading">Tambah Komisi Produk Per User</div>
  ...
  export default {
    ...
    methods: {
     ...
     var app = this;
      ...
      alert(pesan){
        this.$swal({
          title: "Berhasil Menambah Komisi Produk",
          text: pesan,
          icon: "success"
        });
      },
      saveForm(){
        ...
        axios.post(this.url,newKomisiProduk)
        .then((resp) => {
          this.alert('Berhasil Menambah KomisiProduk ' + this.komisiProduk.nama );
